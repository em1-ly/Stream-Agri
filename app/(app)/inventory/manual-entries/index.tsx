...
const menuItems = [
  {
    id: '1',
    title: 'Creating Missing Receipts Notes',
    href: '/inventory/manual-entries/create-missing-receipt-note',
  },

  {
    id: '3',
    title: 'Missing Receipts Notes',
    href: '/inventory/manual-entries/missing-receipt-notes',
  },
  {
    id: '4',
    title: 'Enter Data Capturing Records',
    href: '/inventory/manual-entries/enter-data-capturing-records',
  },
  {
    id: '2',
    title: 'Data Capturing Records',
    href: '/inventory/manual-entries/data-capturing-records',
  },
...
export default function ManualEntriesScreen() {
  return (
    <>

...
const RackLoadingScreen = () => {
  ...
  const handleStartScanning = () => {
    ...
    router.push({
      pathname: '/(app)/inventory/operations/rack-loading-scan',
      params: {
  ...
  return (
    <>
      <Stack.Screen options={{title: 'Rack Loading Scan Bale', headerShown: true }} />
      <KeyboardAvoidingView
...
export default RackLoadingScreen;
